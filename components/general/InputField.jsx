        ...
        >
          {(type !== "select" && type !== "textarea") &&
            <input
              ...
              className={`${type && type.toLowerCase() === "checkbox"? "w-auto py-0" :"w-full py-3"}  drop-shadow-none border border-slate-300  px-3 ${rightIcon ||
              type === "password"
                ? "pr-10"
                : "pr-3"} ${leftIcon
                ? "pl-10"
          ...
          {type === "select" &&
            <select
              id={id ? id : ""}
              className={`w-full drop-shadow-none border border-slate-300 py-3 px-3 ${rightIcon ||
              type === "password"
                ? "pr-10"
                : "pr-3"} ${leftIcon
                ? "pl-10"
          ...
          {type === "textarea" &&
            <textarea
              id={id ? id : ""}
              placeholder={placeholder ? placeholder : "Type here"}
              className={`w-full drop-shadow-none border border-slate-300 py-3 px-3 outline-none rounded-md shadow-none ${inputClassName
                ? inputClassName
                : ""}`}
              {...props}
            />}
          ...
          {type === "password"?
            <button
              type="button"
              className="absolute top-1/2 -translate-y-1/2 right-0 h-full px-4"
              onClick={() => {
                var newType = "text";
            ...
            {leftIcon &&
              <button
                ...
                className="absolute top-1/2 -translate-y-1/2 left-0 h-full px-4"
              >
                {leftIcon}
              </button>}
